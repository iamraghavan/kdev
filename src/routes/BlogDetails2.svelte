            ...
            <div class="blog-details-page pe-xxl-5 me-xxl-3">
              {#if blogData2}
                <article class="blog-details-meta">
                  ...
                  <div class="img-meta mb-15"><img src={blogData2.image} alt={blogData2.title} class="lazy-img" style=""></div>
                  {@html blogData2.content}
